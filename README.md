...
is for learners (NGSL / NAWL / BSL membership) and how modern its evidence is.
...
**[LexiDeck Multilingual](ecosystem/lexideck-multilingual/README.md)** is an Anki system built on this
list: the 5,000 LexiCore words **plus ~700 additional high-utility words (≈5,700 total, A1–C1)**,
5 rotating example sentences per word, human-recorded sentence audio, IPA and an illustration
per word, with translations in 12 languages. Screenshots and a field-by-field description of
the card model — derived from the free sample deck — are in that folder.
